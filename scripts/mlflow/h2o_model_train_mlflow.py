...
experiment_name = date_time_str+'-'+'MLFLOW_DEMO'+'-' + os.environ['DOMINO_STARTING_USERNAME'] + '-' + os.environ['DOMINO_PROJECT_NAME']
...
while(MAX_M>1):
    ...
    aml = H2OAutoML(max_models=MAX_M, max_runtime_secs=30, sort_metric="r2")
    ...
    print("max_models: ", MAX_M)
    print("R2 Score: ", r2)
    print("MSE: ", mse)
    mlflow.log_param("max_models", MAX_M)
