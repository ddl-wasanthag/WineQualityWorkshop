...
experiment_name = date_time_str+'-'+'MLFLOW_DEMO_SKLEARN'+'-' + os.environ['DOMINO_STARTING_USERNAME'] + '-' + os.environ['DOMINO_PROJECT_NAME']
model_name = 'DEMO_SKLEARN'+'-' + os.environ['DOMINO_PROJECT_NAME']
if myprefix!='':
